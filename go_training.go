...
func másAlláDelHola() {
	...
	y := 4
	suma1, producto1 := aprendeMúltiple(x, y) // La función devuelve dos
	// valores.
	fmt.Println("suma:", suma1, "producto:", producto1) // Simple salida.
